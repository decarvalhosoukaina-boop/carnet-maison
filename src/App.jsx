...
const INITIAL_RECIPES = [
  ...
  {
    id: 21, name: "Paella poulet & chorizo", subtitle: "Version familiale sans fruits de mer, riz safrané", category: "Poulet",
    servings: 3, prepTime: 15, cookTime: 35, temp: null,
    ingredients: [
      { name: "Hauts de cuisse de poulet désossés", qty: 6, unit: "" },
      { name: "Chorizo doux", qty: 150, unit: "g" },
      { name: "Riz rond (bomba ou arborio)", qty: 250, unit: "g" },
      { name: "Oignon", qty: 1, unit: "" },
      ...
      { name: "Safran ou paprika fumé", qty: 1, unit: "pincée" },
      { name: "Paprika doux", qty: 1, unit: "cac" },
      { name: "Huile d'olive", qty: 2, unit: "cas" },
      { name: "Citron", qty: 1, unit: "" },
    ],
    prep: [
      { ingredient: "Poulet", action: "couper en gros morceaux" },
      { ingredient: "Chorizo doux", action: "couper en rondelles" },
      { ingredient: "Oignons", action: "hacher" },
      { ingredient: "Poivron rouge", action: "émincer finement" },
      { ingredient: "Ail", action: "écraser" },
    ],
    assembly: [
      "Chauffer l'huile d'olive dans une grande poêle et faire dorer les morceaux de poulet sur toutes les faces, puis réserver",
      "Dans la même poêle, faire revenir le chorizo 2 min pour libérer son huile parfumée",
      "Ajouter l'oignon, le poivron et l'ail, faire suer 5 min",
      "Incorporer les tomates concassées, le paprika et le safran, laisser réduire 3 min",
      "Ajouter le riz et remuer 1 min pour bien l'enrober des sucs",
      "Verser le bouillon chaud, remettre le poulet et laisser mijoter à feu moyen sans remuer 15 min",
      "Ajouter les petits pois, poursuivre 5 min jusqu'à absorption du bouillon",
      "Laisser reposer 5 min hors du feu, servir avec le citron en quartiers",
    ],
    steps: [
      "Dorer les morceaux de poulet dans l'huile, réserver",
      "Faire revenir le chorizo, puis oignon, poivron et ail",
      "Ajouter tomates, paprika et safran, réduire 3 min",
      "Nacrer le riz 1 min, verser le bouillon et remettre le poulet",
      "Mijoter 15 min sans remuer, ajouter les petits pois, 5 min de plus",
      "Reposer 5 min, servir avec le citron",
    ],
    notes: [
      "Version terre sans fruits de mer — le chorizo parfume tout le riz.",
      "Astuce : râpe une carotte avec les oignons pour cacher un légume dans la sauce.",
      "Coupe le poivron très fin si Neo n'aime pas les gros morceaux.",
      "Se réchauffe très bien à la poêle avec un filet d'eau.",
    ],
    cookMethod: "feux",
  },
  {
    id: 22, name: "Mafé de bœuf", subtitle: "Mijoté à la pâte d'arachide, légumes fondants", category: "Boeuf",
    servings: 4, prepTime: 20, cookTime: 90, temp: null,
    ingredients: [
      { name: "Bœuf à mijoter (paleron ou gîte)", qty: 800, unit: "g" },
      { name: "Pâte d'arachide (beurre de cacahuète non sucré)", qty: 150, unit: "g" },
      { name: "Concentré de tomates", qty: 2, unit: "cas" },
      { name: "Oignon", qty: 2, unit: "" },
      { name: "Gousses d'ail", qty: 3, unit: "" },
      { name: "Carottes", qty: 3, unit: "" },
      { name: "Patate douce", qty: 1, unit: "" },
      { name: "Chou (quelques feuilles)", qty: 200, unit: "g" },
      { name: "Tomates concassées", qty: 200, unit: "g" },
      { name: "Bouillon de bœuf", qty: 800, unit: "ml" },
      { name: "Gingembre frais", qty: 1, unit: "cac" },
      { name: "Huile", qty: 2, unit: "cas" },
      { name: "Feuille de laurier", qty: 1, unit: "" },
    ],
    prep: [
      { ingredient: "Bœuf à mijoter (paleron ou gîte)", action: "couper en gros cubes" },
      { ingredient: "Oignons", action: "hacher" },
      { ingredient: "Ail", action: "écraser" },
      { ingredient: "Carottes", action: "couper en tronçons" },
      { ingredient: "Patate douce", action: "couper en gros cubes" },
      { ingredient: "Chou (quelques feuilles)", action: "couper en lanières" },
      { ingredient: "Gingembre frais", action: "râper" },
    ],
    assembly: [
      "Chauffer l'huile dans une cocotte et faire dorer les cubes de bœuf sur toutes les faces, puis réserver",
      "Faire revenir les oignons, l'ail et le gingembre 5 min",
      "Ajouter le concentré de tomates, cuire 2 min en remuant",
      "Délayer la pâte d'arachide avec une louche de bouillon chaud, puis l'incorporer dans la cocotte",
      "Remettre le bœuf, ajouter les tomates concassées, le laurier et le reste du bouillon, mélanger et laisser mijoter 45 min à couvert",
      "Ajouter les carottes, la patate douce et le chou, poursuivre la cuisson 30 min jusqu'à ce que la viande soit fondante et la sauce onctueuse",
      "Rectifier l'assaisonnement, servir avec du riz blanc",
    ],
    steps: [
      "Dorer les cubes de bœuf dans l'huile, réserver",
      "Revenir oignons, ail et gingembre",
      "Ajouter concentré de tomates, puis la pâte d'arachide délayée dans le bouillon",
      "Remettre le bœuf avec tomates, laurier et bouillon, mijoter 45 min",
      "Ajouter carottes, patate douce et chou, cuire 30 min de plus",
      "Servir avec du riz blanc",
    ],
    notes: [
      "La patate douce, les carottes et le chou fondent dans la sauce riche à l'arachide — légumes cachés garantis.",
      "Meilleur réchauffé le lendemain, quand les saveurs se sont développées.",
      "Se congèle très bien — idéal pour le batch cooking.",
      "Pour une sauce plus lisse, tu peux mixer une partie des légumes en fin de cuisson.",
    ],
    cookMethod: "feux",
  },
  {
    id: 23, name: "One-pot pâtes bolognaise crémeuse", subtitle: "Tout dans une casserole, légumes cachés, rapide", category: "Boeuf",
    servings: 4, prepTime: 10, cookTime: 25, temp: null,
    ingredients: [
      { name: "Bœuf haché", qty: 500, unit: "g" },
      { name: "Pâtes (penne ou fusilli)", qty: 400, unit: "g" },
      { name: "Oignon", qty: 1, unit: "" },
      { name: "Gousses d'ail", qty: 2, unit: "" },
      ...
      { name: "Bouillon de bœuf", qty: 700, unit: "ml" },
      { name: "Herbes de Provence", qty: 1, unit: "cac" },
      { name: "Fromage râpé", qty: 80, unit: "g" },
      { name: "Huile d'olive", qty: 2, unit: "cas" },
    ],
    prep: [
      { ingredient: "Oignons", action: "hacher" },
      { ingredient: "Ail", action: "écraser" },
      { ingredient: "Carottes", action: "râper finement" },
      { ingredient: "Courgette", action: "râper finement" },
    ],
    assembly: [
      "Chauffer l'huile dans une grande casserole, faire revenir l'oignon et l'ail 3 min",
      "Ajouter le bœuf haché, faire dorer en l'émiettant",
      "Incorporer la carotte et la courgette râpées, cuire 3 min pour qu'elles fondent",
      "Ajouter le concentré de tomates, les tomates concassées et les herbes de Provence",
      "Verser les pâtes crues et le bouillon, mélanger, porter à ébullition puis laisser mijoter 12-15 min en remuant de temps en temps jusqu'à ce que les pâtes soient cuites",
      "Hors du feu, incorporer la crème fraîche et le fromage râpé, mélanger jusqu'à sauce onctueuse",
    ],
    steps: [
      "Faire revenir oignon et ail",
      "Dorer le bœuf haché émietté",
      "Ajouter carotte et courgette râpées, faire fondre",
      "Tomates concassées, concentré et herbes",
      "Pâtes crues + bouillon, mijoter 12-15 min",
      "Hors du feu : crème et fromage râpé",
    ],
    notes: [
      "Carotte et courgette râpées disparaissent dans la sauce — légumes cachés parfaits.",
      "Tout cuit dans une seule casserole, même les pâtes : moins de vaisselle.",
      "Ajoute un peu de bouillon en réchauffant, les pâtes absorbent le liquide.",
      "Neo adorera la version crémeuse et fromagère.",
    ],
    cookMethod: "feux",
  },
  {
    id: 24, name: "Gyros grec au porc", subtitle: "Porc mariné, tzatziki maison, pita — comme en Grèce", category: "Porc",
    servings: 4, prepTime: 20, cookTime: 15, temp: null,
    marinadeNote: "Mariner le porc au moins 1h, idéalement une nuit, dans l'huile d'olive, le vinaigre de vin rouge, l'origan, le paprika, le cumin et l'ail écrasé.",
    ingredients: [
      { name: "Échine de porc (ou filet)", qty: 800, unit: "g" },
      { name: "Gousses d'ail", qty: 3, unit: "" },
      { name: "Huile d'olive", qty: 3, unit: "cas" },
      { name: "Vinaigre de vin rouge", qty: 1, unit: "cas" },
      { name: "Origan séché", qty: 2, unit: "cac" },
      { name: "Paprika doux", qty: 1, unit: "cac" },
      { name: "Cumin moulu", qty: 1, unit: "cac" },
      { name: "Pains pita grecs épais", qty: 4, unit: "" },
      { name: "Tomates", qty: 2, unit: "" },
      { name: "Oignon rouge", qty: 1, unit: "" },
      { name: "Yaourt grec épais", qty: 400, unit: "g" },
      { name: "Concombre", qty: 1, unit: "" },
      { name: "Aneth frais ou menthe", qty: 1, unit: "cas" },
    ],
    prep: [
      { ingredient: "Échine de porc (ou filet)", action: "couper en lanières épaisses" },
      { ingredient: "Ail", action: "écraser" },
      { ingredient: "Concombre", action: "râper et presser pour retirer l'eau" },
      { ingredient: "Oignon rouge", action: "émincer finement" },
      { ingredient: "Tomates", action: "couper en tranches ou dés" },
    ],
    assembly: [
      "Mélanger le porc avec l'ail écrasé, l'huile d'olive, le vinaigre, l'origan, le paprika et le cumin, laisser mariner (1h minimum)",
      "Préparer le tzatziki : mélanger le concombre râpé et pressé avec le yaourt grec, 1 gousse d'ail, l'aneth et un filet d'huile, réserver au frais",
      "Chauffer une poêle bien chaude et saisir les lanières de porc 3-4 min de chaque côté jusqu'à ce qu'elles soient dorées et caramélisées",
      "Passer les pitas 30 secondes de chaque côté dans la poêle chaude pour les assouplir",
      "Garnir chaque pita de tzatziki, porc grillé, tomates et oignon rouge, rouler et servir",
    ],
    steps: [
      "Mariner le porc dans les épices grecques (1h minimum)",
      "Tzatziki : concombre pressé + yaourt grec + ail + aneth",
      "Saisir le porc 3-4 min par face jusqu'à caramélisation",
      "Réchauffer les pitas dans la poêle",
      "Garnir : tzatziki, porc, tomate, oignon rouge",
    ],
    notes: [
      "Le vrai goût grec vient de la marinade vinaigre-origan et du tzatziki bien égoutté.",
      "Essore bien le concombre pour un tzatziki épais.",
      "Astuce grecque : ajoute quelques frites dans la pita, Neo adorera.",
      "Batch : viande marinée congelable crue, tzatziki se garde 3 jours.",
      "RÉCHAUFFAGE CROUSTILLANT : au moment de servir, passe les lanières de porc déjà cuites à l'air fryer 4-6 min à 200°C (secoue à mi-cuisson). Les bords redeviennent caramélisés comme fraîchement grillés. Ne passe PAS au micro-ondes avant, ça ramollit.",
    ],
    cookMethod: "feux",
  },
  {
    id: 25, name: "Tacos au bœuf effiloché", subtitle: "Bœuf mijoté aux épices mexicaines, build-your-own", category: "Boeuf",
    servings: 4, prepTime: 20, cookTime: 180, temp: null,
    ingredients: [
      { name: "Paleron ou macreuse de bœuf", qty: 900, unit: "g" },
      { name: "Oignon", qty: 2, unit: "" },
      { name: "Gousses d'ail", qty: 3, unit: "" },
      { name: "Poivron rouge", qty: 1, unit: "" },
      { name: "Tomates concassées", qty: 400, unit: "g" },
      { name: "Concentré de tomates", qty: 2, unit: "cas" },
      { name: "Cumin moulu", qty: 2, unit: "cac" },
      { name: "Paprika fumé", qty: 1, unit: "cas" },
      { name: "Origan séché", qty: 1, unit: "cac" },
      { name: "Bouillon de bœuf", qty: 400, unit: "ml" },
      { name: "Jus de lime ou citron", qty: 1, unit: "" },
      { name: "Huile", qty: 2, unit: "cas" },
      { name: "Petites tortillas de maïs ou blé", qty: 12, unit: "" },
      { name: "Fromage râpé (cheddar)", qty: 150, unit: "g" },
    ],
    prep: [
      { ingredient: "Paleron ou macreuse de bœuf", action: "couper en gros morceaux" },
      { ingredient: "Oignons", action: "hacher" },
      { ingredient: "Ail", action: "écraser" },
      { ingredient: "Poivron rouge", action: "couper en lanières" },
    ],
    assembly: [
      "Chauffer l'huile dans une cocotte et faire dorer les morceaux de bœuf sur toutes les faces, puis réserver",
      "Faire revenir les oignons, l'ail et le poivron 5 min, ajouter le cumin, le paprika fumé et l'origan, remuer 1 min",
      "Ajouter le concentré de tomates, les tomates concassées et le bouillon",
      "Remettre le bœuf, couvrir et laisser mijoter à feu doux 2h30 à 3h jusqu'à ce que la viande se défasse facilement",
      "Sortir le bœuf, l'effilocher à la fourchette et le remettre dans la sauce avec le jus de lime, réduire à découvert 10 min",
      "Réchauffer les tortillas, garnir de bœuf effiloché, fromage râpé et garnitures au choix",
    ],
    steps: [
      "Dorer les morceaux de bœuf, réserver",
      "Revenir oignons, ail, poivron et épices",
      "Ajouter tomates, concentré et bouillon",
      "Remettre le bœuf, mijoter 2h30-3h à couvert",
      "Effilocher, remettre dans la sauce avec la lime, réduire 10 min",
      "Garnir les tortillas en build-your-own",
    ],
    notes: [
      "Cuisson longue et douce jusqu'à ce que le bœuf se défasse tout seul à la fourchette.",
      "Batch : se garde 4 jours au frigo, se congèle très bien, meilleur réchauffé.",
      "Garnitures build-your-own à part : avocat, maïs, oignon rouge, coriandre, crème, sauce piquante — Neo compose son taco.",
      "Version express : cocotte-minute 45 min au lieu de 3h.",
    ],
    cookMethod: "feux",
  },
  {
    id: 26, name: "Brochettes de poulet yakitori", subtitle: "Marinade soja-miel-gingembre caramélisée, effet resto japonais", category: "Poulet",
    servings: 4, prepTime: 20, cookTime: 15, temp: 200,
    marinadeNote: "Mariner le poulet au moins 30 min (idéalement 2h) dans la sauce soja, le miel, le mirin, l'ail, le gingembre et l'huile de sésame.",
    ingredients: [
      { name: "Hauts de cuisse de poulet désossés", qty: 800, unit: "g" },
      { name: "Sauce soja", qty: 6, unit: "cas" },
      { name: "Miel", qty: 3, unit: "cas" },
      { name: "Mirin (ou vinaigre de riz + sucre)", qty: 2, unit: "cas" },
      { name: "Gousses d'ail", qty: 2, unit: "" },
      { name: "Gingembre frais râpé", qty: 1, unit: "cas" },
      { name: "Huile de sésame", qty: 1, unit: "cas" },
      { name: "Oignons nouveaux (ou 1 poireau)", qty: 4, unit: "" },
      { name: "Graines de sésame", qty: 1, unit: "cas" },
      { name: "Riz japonais (ou basmati)", qty: 300, unit: "g" },
    ],
    prep: [
      { ingredient: "Hauts de cuisse de poulet désossés", action: "couper en cubes réguliers" },
      { ingredient: "Ail", action: "écraser" },
      { ingredient: "Gingembre frais râpé", action: "râper" },
      { ingredient: "Oignons nouveaux (ou 1 poireau)", action: "couper en tronçons de 3 cm" },
    ],
    assembly: [
      "Mélanger la sauce soja, le miel, le mirin, l'ail écrasé, le gingembre et l'huile de sésame, verser sur le poulet et laisser mariner (30 min minimum)",
      "Monter les brochettes en alternant poulet et oignon nouveau",
      "Rincer et cuire le riz selon les indications du paquet",
      "Cuire les brochettes à la poêle chaude, au grill ou au four (200°C) 10-12 min en les retournant, jusqu'à ce que le poulet soit doré et caramélisé, badigeonner du reste de marinade en cours de cuisson",
      "Parsemer de graines de sésame et servir sur le riz avec la sauce réduite",
    ],
    steps: [
      "Mariner le poulet dans soja-miel-gingembre (30 min min)",
      "Monter les brochettes poulet + oignon nouveau",
      "Cuire le riz",
      "Cuire les brochettes 10-12 min en badigeonnant de marinade",
      "Sésame dessus, servir sur le riz",
    ],
    notes: [
      "Le vrai yakitori alterne poulet et oignon nouveau sur la brochette.",
      "Batch : poulet mariné congelable cru dans sa marinade.",
      "Fais réduire le reste de marinade en casserole pour une sauce à napper.",
      "Pics en bois : tremper 20 min dans l'eau pour éviter qu'ils brûlent.",
      "Air fryer : 200°C 10-12 min en retournant, effet grillé sans barbecue.",
    ],
    cookMethod: "feux",
  },
  {
    id: 27, name: "Gratin de gnocchis crémeux au jambon", subtitle: "Sauce crème-jambon, courgette cachée, gratiné — prêt en 30 min", category: "Rapide",
    servings: 4, prepTime: 10, cookTime: 20, temp: 200,
    ingredients: [
      { name: "Gnocchis frais", qty: 800, unit: "g" },
      { name: "Dés de jambon (ou lardons)", qty: 200, unit: "g" },
      { name: "Oignon", qty: 1, unit: "" },
      { name: "Courgette", qty: 1, unit: "" },
      { name: "Crème fraîche", qty: 200, unit: "ml" },
      { name: "Lait", qty: 150, unit: "ml" },
      { name: "Fromage râpé (emmental ou comté)", qty: 150, unit: "g" },
      { name: "Gousse d'ail", qty: 1, unit: "" },
    ...
    prep: [
      { ingredient: "Oignons", action: "hacher" },
      { ingredient: "Courgette", action: "râper" },
      { ingredient: "Ail", action: "écraser" },
    ],
    assembly: [
      "Chauffer l'huile dans une poêle, faire revenir l'oignon et l'ail 3 min, ajouter les dés de jambon et faire dorer 2 min",
      "Ajouter la courgette râpée, cuire 3-4 min jusqu'à ce qu'elle rende son eau et fonde",
      "Verser la crème et le lait, ajouter la muscade, sel et poivre, laisser frémir 2 min",
      "Ajouter les gnocchis crus directement dans la sauce, mélanger pour bien les enrober, verser dans un plat à gratin",
      "Parsemer de fromage râpé et enfourner à 200°C pendant 20 min jusqu'à ce que le dessus soit doré et bouillonnant",
    ],
    steps: [
      "Revenir oignon, ail et jambon",
      "Faire fondre la courgette râpée",
      "Crème + lait + muscade, frémir 2 min",
      "Gnocchis crus dans la sauce, verser en plat à gratin",
      "Fromage dessus, gratiner 20 min à 200°C",
    ],
    notes: [
      "La courgette râpée fond dans la sauce — légume caché parfait pour Neo.",
      "Batch : se prépare à l'avance (2 jours au frigo) ou se congèle avant cuisson.",
      "Pour plus riche, remplace une partie du lait par de la crème.",
      "Air fryer possible si le plat rentre : 180°C 8-10 min.",
    ],
    cookMethod: "four",
  },
  {
    id: 28, name: "Buuz mongols au bœuf", subtitle: "Raviolis mongols, farce bœuf-cumin, cuits à l'air fryer", category: "Boeuf",
    servings: 4, prepTime: 45, cookTime: 12, temp: 180,
    ingredients: [
      { name: "Farine", qty: 300, unit: "g" },
      { name: "Eau tiède (pour la pâte)", qty: 150, unit: "ml" },
      { name: "Bœuf haché (pas trop maigre, 15%)", qty: 500, unit: "g" },
      { name: "Oignon", qty: 1, unit: "" },
      { name: "Gousses d'ail", qty: 3, unit: "" },
      { name: "Cumin moulu", qty: 1, unit: "cac" },
      { name: "Eau (pour la farce)", qty: 4, unit: "cas" },
      { name: "Sel", qty: 1, unit: "cac" },
      { name: "Huile (pour badigeonner)", qty: 1, unit: "cas" },
    ],
    prep: [
      { ingredient: "Oignons", action: "hacher très finement" },
      { ingredient: "Ail", action: "écraser" },
    ],
    assembly: [
      "Mélanger la farine, le sel et l'eau tiède, pétrir 8-10 min jusqu'à une pâte lisse et élastique, couvrir et laisser reposer 30 min",
      "Mélanger le bœuf avec l'oignon et l'ail hachés très fins, le cumin, le sel et l'eau, bien travailler la farce à la main pour qu'elle devienne homogène et collante",
      "Diviser la pâte en petits pâtons, abaisser chacun en disque de 8-10 cm plus épais au centre",
      "Déposer une cuillère de farce au centre de chaque disque, replier les bords en petits plis pour former un sac fermé (ou un demi-cercle bien soudé)",
      "Badigeonner les buuz d'un peu d'huile, cuire à l'air fryer à 180°C pendant 10-12 min jusqu'à ce qu'ils soient dorés et croustillants",
      "Servir chaud avec une sauce soja-vinaigre. Attention au jus brûlant à l'intérieur !",
    ],
    steps: [
      "Pétrir la pâte (farine, eau, sel), reposer 30 min",
      "Farce : bœuf, oignon, ail, cumin, sel, eau — bien travailler",
      "Étaler des disques de 8-10 cm",
      "Garnir et plier en sac fermé",
      "Air fryer 180°C 10-12 min, badigeonnés d'huile",
      "Servir chaud avec sauce soja-vinaigre",
    ],
    notes: [
      "L'eau dans la farce crée un bouillon juteux à l'intérieur — attention en croquant.",
      "Farce authentique mongole : viande, oignon, ail, cumin, sel. Pas de fioritures.",
      "Batch : congèle les buuz crus sur plaque farinée puis en sachet, cuis directement congelés (+2-3 min).",
      "Alternatives : vapeur 15-18 min, ou poêlés en potstickers (dorer + eau + couvrir).",
    ],
    cookMethod: "four",
  },
  {
    id: 29, name: "Bo bun bœuf citronnelle", subtitle: "Vermicelles, bœuf citronnelle, nems croustillants, nuoc-cham", category: "Boeuf",
    servings: 4, prepTime: 30, cookTime: 15, temp: 200,
    marinadeNote: "Mariner le bœuf 30 min dans la citronnelle et l'ail émincés, la sauce soja, le nuoc-mâm et le sucre.",
    ingredients: [
      { name: "Bœuf (bavette ou rumsteck) en fines lanières", qty: 500, unit: "g" },
      { name: "Tiges de citronnelle", qty: 2, unit: "" },
      { name: "Gousses d'ail", qty: 3, unit: "" },
      { name: "Sauce soja", qty: 2, unit: "cas" },
      { name: "Sauce nuoc-mâm", qty: 1, unit: "cas" },
      { name: "Sucre", qty: 1, unit: "cac" },
      { name: "Vermicelles de riz", qty: 300, unit: "g" },
      { name: "Nems (achetés ou maison)", qty: 8, unit: "" },
      { name: "Carotte", qty: 1, unit: "" },
      { name: "Concombre", qty: 1, unit: "" },
      { name: "Pousses de soja", qty: 100, unit: "g" },
      { name: "Salade (laitue) émincée", qty: 1, unit: "" },
      { name: "Menthe et coriandre", qty: 1, unit: "bouquet" },
      { name: "Cacahuètes concassées", qty: 50, unit: "g" },
      { name: "Nuoc-mâm (pour la sauce)", qty: 3, unit: "cas" },
      { name: "Sucre (pour la sauce)", qty: 2, unit: "cas" },
      { name: "Jus de citron vert", qty: 1, unit: "" },
      { name: "Eau (pour la sauce)", qty: 6, unit: "cas" },
    ],
    prep: [
      { ingredient: "Tiges de citronnelle", action: "émincer finement" },
      { ingredient: "Ail", action: "écraser" },
      { ingredient: "Carotte", action: "râper" },
      { ingredient: "Concombre", action: "tailler en bâtonnets" },
      { ingredient: "Salade (laitue) émincée", action: "émincer" },
      { ingredient: "Menthe et coriandre", action: "ciseler" },
    ],
    assembly: [
      "Mélanger le bœuf avec la citronnelle et l'ail émincés, la sauce soja, le nuoc-mâm et le sucre, laisser mariner 30 min",
      "Préparer la sauce nuoc-cham : mélanger le nuoc-mâm, le sucre, le jus de citron vert, l'eau et une gousse d'ail écrasée",
      "Cuire les vermicelles selon le paquet, rincer à l'eau froide et égoutter",
      "Cuire les nems à l'air fryer (200°C 8 min) ou au four jusqu'à bien dorés et croustillants, les couper en tronçons",
      "Saisir le bœuf mariné à feu vif dans une poêle très chaude 2-3 min, il doit rester tendre",
      "Composer chaque bol : vermicelles, salade et crudités, bœuf, nems croustillants, pousses de soja, herbes, cacahuètes, arroser de nuoc-cham au moment de manger",
    ],
    steps: [
      "Mariner le bœuf dans citronnelle-soja-nuoc-mâm (30 min)",
      "Sauce nuoc-cham : nuoc-mâm, sucre, citron vert, eau, ail",
      "Cuire les vermicelles, rincer à froid",
      "Nems à l'air fryer 200°C 8 min, couper en tronçons",
      "Saisir le bœuf à feu vif 2-3 min",
      "Composer les bols en build-your-own, arroser de sauce",
    ],
    notes: [
      "L'équilibre des textures fait le bo bun : vermicelles souples, bœuf parfumé, nems croustillants, crudités craquantes.",
      "Sauce nuoc-cham : ajuste l'équilibre sucre-acide-salé à ton goût.",
      "Batch : bœuf mariné congelable cru, sauce se garde 1 semaine au frigo.",
      "Sers tout séparé, chacun compose son bol — parfait pour la famille.",
      "Vermicelles tièdes ou froids, jamais brûlants.",
    ],
    cookMethod: "feux",
  },
  {
    id: 30, name: "Tenders de poulet croustillants façon Southern", subtitle: "Marinés buttermilk épicé, panure parmesan, air fryer", category: "Poulet",
    servings: 4, prepTime: 20, cookTime: 14, temp: 200,
    marinadeNote: "Mariner le poulet au moins 2h (idéalement une nuit) dans le buttermilk, la moutarde et les épices (paprika, ail, oignon, cumin, piment).",
    ingredients: [
      { name: "Aiguillettes de poulet (ou blancs en lanières)", qty: 800, unit: "g" },
      { name: "Buttermilk (ou lait + jus de citron)", qty: 250, unit: "ml" },
      { name: "Paprika fumé", qty: 2, unit: "cac" },
      { name: "Ail en poudre", qty: 1, unit: "cac" },
      { name: "Oignon en poudre", qty: 1, unit: "cac" },
      { name: "Cumin moulu", qty: 1, unit: "cac" },
      { name: "Piment de Cayenne (facultatif)", qty: 0.5, unit: "cac" },
      { name: "Moutarde", qty: 1, unit: "cas" },
      { name: "Chapelure panko", qty: 200, unit: "g" },
    ...
    prep: [],
    assembly: [
      "Mélanger le buttermilk, la moutarde, le paprika, l'ail et l'oignon en poudre, le cumin et le piment, y plonger les aiguillettes et laisser mariner (2h minimum)",
      "Préparer 3 assiettes : farine, œufs battus, mélange panko + parmesan",
      "Égoutter chaque tender, le passer dans la farine, puis l'œuf, puis la chapelure en pressant bien pour qu'elle adhère",
      "Disposer les tenders dans l'air fryer sans les superposer, vaporiser d'un peu d'huile, cuire à 200°C 12-14 min en les retournant à mi-cuisson",
      "Servir aussitôt avec les sauces au choix (barbecue, miel-moutarde, ranch)",
    ],
    steps: [
      "Mariner le poulet dans buttermilk épicé (2h min)",
      "3 assiettes : farine, œufs battus, panko + parmesan",
      "Paner : farine, œuf, chapelure en pressant",
      "Air fryer 200°C 12-14 min, retourner à mi-cuisson",
      "Servir avec sauces au choix",
    ],
    notes: [
      "3 secrets du goût : marinade buttermilk, épices dans la marinade ET la panure, parmesan pour l'umami.",
      "Batch : congèle les tenders panés crus, cuis directement congelés (+3-4 min).",
      "Air fryer plus sain que la friture, tout aussi croustillant.",
      "Vaporise un peu d'huile avant cuisson pour une dorure parfaite.",
      "Enlève ou dose léger le piment de Cayenne pour Neo.",
    ],
    cookMethod: "four",
  },
  {
    id: 31, name: "Pizza napolitaine", subtitle: "Pâte au poolish, pré-ferment la veille — cuisson Kamado", category: "Pizza",
    servings: 3, prepTime: 40, cookTime: 10, temp: 280,
    marinadeNote: "Le poolish se prépare la veille : 16 à 24h de fermentation au frigo avant de faire la pâte.",
    ingredients: [
      { name: "Eau (poolish)", qty: 90, unit: "ml" },
      { name: "Farine (poolish)", qty: 90, unit: "g" },
      { name: "Levure de boulanger sèche (poolish)", qty: 1.5, unit: "g" },
      { name: "Miel", qty: 1.5, unit: "g" },
      { name: "Eau (pâte)", qty: 210, unit: "ml" },
      { name: "Farine (pâte)", qty: 375, unit: "g" },
      { name: "Sel", qty: 12, unit: "g" },
      { name: "Semoule fine (pour les boules)", qty: 2, unit: "cas" },
      { name: "Huile d'olive (pour les mains)", qty: 2, unit: "cas" },
      { name: "Sauce tomate", qty: 250, unit: "g" },
      { name: "Mozzarella", qty: 250, unit: "g" },
      { name: "Parmesan râpé", qty: 60, unit: "g" },
      { name: "Jambon blanc", qty: 150, unit: "g" },
      { name: "Saucisse (chair ou rondelles)", qty: 150, unit: "g" },
      { name: "Olives noires", qty: 80, unit: "g" },
      { name: "Basilic frais", qty: 1, unit: "bouquet" },
    ],
    prep: [],
    assembly: [
      "La veille : mélanger l'eau, la farine, la levure et le miel du poolish jusqu'à une pâte liquide homogène",
      "Laisser le poolish 1h à température ambiante puis 16 à 24h au frigo, couvert",
      "Le jour J : mélanger le poolish avec l'eau de la pâte, bien délayer",
      "Ajouter la farine, mélanger, puis le sel, mélanger à nouveau",
      "Travailler à la main jusqu'à former une boule — la pâte est collante, c'est normal",
      "Poser la boule sur le plan, couvrir d'un bol et laisser reposer 15 min",
      "Se huiler les mains, rabattre les bords de la pâte vers le dessous en tournant pour former un ballon bien lisse (le haut reste en haut)",
      "Huiler le fond d'un saladier, y déposer la boule, couvrir et laisser reposer 30 min à température ambiante",
      "Sortir la pâte en gardant le haut en haut, se huiler les mains, diviser et façonner en 3 boules",
      "Déposer les boules sur un plat fariné à la semoule, couvrir et laisser lever 2h à température ambiante",
      "Étaler chaque boule à la main en poussant l'air du centre vers les bords (pour former la belle croûte gonflée), étaler la sauce tomate, ajouter la mozzarella, le parmesan, le jambon, la saucisse et les olives noires, cuire au Kamado avec pierre à pizza, montée à 350-400°C, 4-6 min en tournant à mi-cuisson",
      "À la sortie, parsemer de basilic frais et d'un filet d'huile d'olive",
    ],
    steps: [
      "Veille : poolish (eau, farine, levure, miel), 1h puis 16-24h au frigo",
      "Jour J : poolish + eau, puis farine, puis sel, mélanger à la main",
      "Former une boule collante, couvrir d'un bol, reposer 15 min",
      "Mains huilées : bouler en ballon lisse, saladier huilé, reposer 30 min",
      "Diviser en 3 boules, poser sur semoule, couvrir, lever 2h",
      "Étaler en poussant l'air vers les bords, sauce, mozza, parmesan, jambon, saucisse, olives, Kamado 4-6 min",
      "Basilic frais et filet d'huile à la sortie",
    ],
    notes: [
      "CONGÉLATION : congèle les boules à l'étape des 3 boules formées (avant la levée de 2h). Mets-les dans des sachets huilés individuels. Pour cuire : sors une boule le matin, laisse-la décongeler et lever tranquillement à température ambiante avant d'étaler.",
      "La pâte collante après mélange, c'est normal — ne rajoute pas de farine, c'est ce qui la rend aérée.",
      "Le poolish + le miel donnent une pâte légère, digeste et bien gonflée à la cuisson.",
      "KAMADO : préchauffe bien avec la pierre à pizza en place, vise 350-400°C. Le déflecteur de chaleur est indispensable pour ne pas brûler le dessous. Tourne la pizza à mi-cuisson pour une cuisson homogène.",
      "1,5g de levure ≈ une demi-cuillère à café rase.",
    ],
    cookMethod: "four",
  },
];
...
export default function BatchCooking() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      db.saveCurrentWeek({ week_status: weekStatus || "idle", selected_recipes: selected, recipe_servings: recipeServings, active_shopping_list: activeShoppingList || null, owned_ingredients: ownedIngredients, manual_items: manualItems, week_plan: weekPlan }).catch(() => {});
    }, 1000);
                    ...
                    <div onClick={() => setPlanPickingDay(planPickingDay === day ? null : day)} style={{
                      ...
                      {weekPlan[day] ? (
                        <div style={{ textAlign: "center" }}>
                          <div style={{ fontSize: 22, marginBottom: 3 }}>{weekPlan[day].category === "Poulet" ? "🍗" : weekPlan[day].category === "Boeuf" ? "🥩" : weekPlan[day].category === "Porc" ? "🐷" : "🍽️"}</div>
                          <div style={{ fontSize: 9, fontWeight: 500, color: COLORS.ink, lineHeight: 1.3 }}>{weekPlan[day].name.length > 12 ? weekPlan[day].name.slice(0,11) + "…" : weekPlan[day].name}</div>
                ...
                <div style={{ background: COLORS.card, borderRadius: 16, border: "1px solid " + COLORS.line, marginBottom: 16, overflow: "hidden" }}>
                  ...
                  {weekPlan[planPickingDay] && (
                    <div onClick={() => { setWeekPlan(prev => ({ ...prev, [planPickingDay]: null })); setPlanPickingDay(null); }}
                      style={{ padding: "12px 16px", fontSize: 13, color: "#c0392b", borderBottom: "1px solid " + COLORS.line, cursor: "pointer" }}>Retirer ce plat</div>
                  )}
                  {selected.length === 0
                    ? <div style={{ padding: 16, fontSize: 13, color: COLORS.inkMuted }}>Sélectionne des recettes dans Recettes d'abord</div>
                    : (() => {
                        const available = selected.filter(r =>
                          !Object.entries(weekPlan).some(([d, p]) => p && p.id === r.id && d !== planPickingDay)
                        );
                        return available.length === 0
                          ? <div style={{ padding: 16, fontSize: 13, color: COLORS.inkMuted }}>Tous les plats sont déjà planifiés</div>
                          : available.map(r => (
